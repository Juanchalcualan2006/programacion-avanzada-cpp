...
int main() {
    {
        SesionEstudio s1(20);
        bool resultado = s1.setHorario(8.0, 10.0);
        std::cout << "Horario 1 aceptado: " << std::boolalpha << resultado << std::endl;

        SesionEstudio s2(90);
        resultado = s2.setHorario(23.0, 22.0);
        std::cout << "Horario 2 aceptado: " << std::boolalpha << resultado << std::endl;

        SesionEstudio s3(15);
        resultado = s3.setHorario(14.0, 16.0);
        std::cout << "Horario 3 aceptado: " << std::boolalpha << resultado << std::endl;
