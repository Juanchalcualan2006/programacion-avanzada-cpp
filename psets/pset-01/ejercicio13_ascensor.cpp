...
int main() {
    ...
    resultado = a.setRangoPisos(-1, 20);
    std::cout << "Rango aceptado (-1 a 20): " << std::boolalpha << resultado << std::endl;
    std::cout << "Minimo: " << a.getPisoMinimo() << std::endl;
    std::cout << "Maximo: " << a.getPisoMaximo() << std::endl;

    resultado = a.setRangoPisos(30, 10);
    std::cout << "Rango aceptado (30 a 10): " << std::boolalpha << resultado << std::endl;
    std::cout << "Minimo: " << a.getPisoMinimo() << std::endl;
    std::cout << "Maximo: " << a.getPisoMaximo() << std::endl;
